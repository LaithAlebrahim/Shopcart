...
export function StoreItem({id,name,price,imgUrl}:StoreItemProps){
    ...
    const{getQuantitity,increaseQuantity,decreaseQuantity,removeFromCart}=useShoppingCart()
    const quantity =getQuantitity(id) 
...
{quantity===0 ? (
    ...
    <div className="d-flex align-items-center justifu-content-center" style={{gap:".5rem"}}><Button  onClick={()=>decreaseQuantity(id)}>-</Button>
   <div>
